...
<body class="bg-surface min-h-screen flex items-center justify-center p-container-padding overflow-x-hidden">
    ...
    <div class="fixed inset-0 pointer-events-none overflow-hidden">
        <div
            class="absolute -top-[10%] -left-[5%] w-[40%] h-[40%] bg-surface-container rounded-full blur-[120px] opacity-60">
        </div>
        <div
            class="absolute top-[60%] -right-[10%] w-[50%] h-[50%] bg-surface-container-low rounded-full blur-[100px] opacity-40">
        </div>
    </div>
    <!-- Login Container -->
    <main class="relative z-10 w-full max-w-[440px] animate-in fade-in slide-in-from-bottom-4 duration-700">
        ...
        <div class="flex flex-col items-center mb-stack-lg space-y-unit">
            <div
                class="w-12 h-12 bg-primary rounded-lg flex items-center justify-center text-on-primary mb-2 shadow-xl shadow-primary/10">
            ...
            <p class="font-body-sm text-body-sm text-outline text-center px-4">Management Console — Solução corporativa
                para coordenação de eventos de alta escala.</p>
        </div>
        <!-- Login Card -->
        <form action="" method="post">
            ...
            <div class="glass-card p-8 rounded-xl shadow-2xl shadow-on-surface/[0.03]">
                <form action="#" class="space-y-stack-lg" id="loginForm" method="POST">
                    <!-- Email Field -->
                    <div class="space-y-2">
                        <label class="font-label-md text-label-md text-on-surface block" for="username">E-mail ou Nome
                            de
                            Usuário</label>
                        <div class="relative group">
                            <span
                                class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-outline text-[20px] transition-colors group-focus-within:text-primary">person</span>
                            <input
                                class="login-input w-full pl-10 pr-4 py-3 bg-white border border-outline-variant rounded-lg font-body-md text-on-surface transition-all"
                                id="username" name="username" placeholder="exemplo@eventhub.com" required=""
                                type="text" />
                        </div>
                    </div>
                    <!-- Password Field -->
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            <span
                                class="material-symbols-outlined absolute left-3 top-1/2 -translate-y-1/2 text-outline text-[20px] transition-colors group-focus-within:text-primary">lock</span>
                            <input
                                class="login-input w-full pl-10 pr-4 py-3 bg-white border border-outline-variant rounded-lg font-body-md text-on-surface transition-all"
                ...
                <!-- Submit Button -->
                <button
                    class="w-full bg-primary text-on-primary font-label-md text-label-md py-4 rounded-lg hover:opacity-90 active:scale-[0.98] transition-all shadow-lg shadow-primary/10 flex items-center justify-center gap-2"
                    type="submit">
                    <span>Entrar</span>
        ...
        <footer class="mt-stack-lg text-center space-y-2">
            <p class="font-body-sm text-body-sm text-outline">
                Ainda não tem acesso? <a class="text-primary font-bold hover:underline" href="../config/create_adm.php">Contate o
                    administrador</a>
            </p>
            <div
                class="flex items-center justify-center gap-2 py-4 px-6 bg-surface-container-low rounded-full inline-flex mx-auto border border-outline-variant/30">
                <span class="material-symbols-outlined text-[16px] text-primary" data-weight="fill">database</span>
                <span class="font-label-sm text-label-sm text-on-surface-variant">Pronto para conexão MySQL
                    backend</span>
            </div>
        </footer>
    </main>
    ...
    <div class="hidden lg:block fixed right-0 top-0 bottom-0 w-[40%] h-full">
        <div class="w-full h-full relative overflow-hidden">
            <img alt="Event Management Context" class="w-full h-full object-cover"
            ...
            <div class="absolute bottom-12 left-12 max-w-md">
                <div class="bg-white/10 backdrop-blur-md p-8 rounded-xl border border-white/20">
                    ...
                    <p class="font-body-sm text-body-sm text-white/80 leading-relaxed">
                        Acesso protegido por criptografia de ponta a ponta e auditoria constante de integridade de dados
