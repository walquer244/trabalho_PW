...
<body class="bg-gray-100 p-6">
  <h1 class="text-3xl font-bold text-blue-600 mb-4">Lista de Categorias</h1>
  <a href="create.php" class="bg-green-500 text-white px-4 py-2 rounded">Nova Categoria</a>
